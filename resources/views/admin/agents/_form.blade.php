<div class="card-body">
    ...
    <div class="form-group">
        ...
        <input type="text" class="form-control @error('full_name') is-invalid @enderror" id="full_name"
            name="full_name" value="{{ old('full_name', $agent?->full_name) }}" required>
        @error('full_name')
            <span class="invalid-feedback" role="alert">
                <strong>{{ $message }}</strong>
            </span>
    ...
    <div class="form-group">
        ...
        <select class="form-control @error('agent_type_id') is-invalid @enderror" id="agent_type_id"
            name="agent_type_id" required>
            <option value="">{{ __('attributes.agents.messages.select_agent_type') }}</option>
            @foreach ($agentTypes as $agentType)
                <option value="{{ $agentType->id }}"
                    {{ old('agent_type_id', $agent?->agent_type_id) == $agentType->id ? 'selected' : '' }}>
                    {{ $agentType->getTranslation('name', app()->getLocale()) }}
                </option>
            @endforeach
        </select>
        @error('agent_type_id')
    ...
    <div class="form-group">
        <label for="agency_id">{{ __('attributes.agents.agency_id') }}</label>
    ...
    <div class="form-group">
        ...
        <input type="text" class="form-control @error('license_number') is-invalid @enderror" id="license_number"
            name="license_number" value="{{ old('license_number', $agent?->license_number) }}">
    ...
    <div class="form-group">
        ...
        <input type="date" class="form-control @error('license_issue_date') is-invalid @enderror"
            ...
            value="{{ old('license_issue_date', $agent?->license_issue_date?->format('Y-m-d')) }}">
    ...
    <div class="form-group">
        ...
        <input type="date" class="form-control @error('license_expiry_date') is-invalid @enderror"
            ...
            value="{{ old('license_expiry_date', $agent?->license_expiry_date?->format('Y-m-d')) }}">
    ...
    <div class="form-group">
        ...
        <input type="text" class="form-control @error('national_id') is-invalid @enderror" id="national_id"
            name="national_id" value="{{ old('national_id', $agent?->national_id) }}">
        @error('national_id')
            <span class="invalid-feedback" role="alert">
                <strong>{{ $message }}</strong>
            </span>
...
<div class="card-footer">
    ...
    <a href="{{ route('admin.agents.index') }}"
        class="btn btn-default">{{ __('attributes.agents.messages.cancel') }}</a>
</div>
