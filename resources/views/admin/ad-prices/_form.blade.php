<div class="card-body">
    ...
    <div class="form-group">
        <label for="icon_path">Icon (SVG, PNG, JPG)</label>
        ...
        @if ($adPrice->icon_path)
            <div class="my-2">
                ...
                <p class="form-text text-muted mt-1">Current icon is shown above. Upload a new file to replace it.</p>
            </div>
        @endif
    ...
    <div class="form-group">
        <label for="type">Type (System Key)</label>
        <input type="text" id="type" name="type" class="form-control @error('type') is-invalid @enderror" value="{{ old('type', $adPrice->type) }}" required>
        <small class="form-text text-muted">A unique key in English, e.g., `regular`, `featured`, `premium`.</small>
