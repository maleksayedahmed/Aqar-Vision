...
@section('content')
    ...
    <main class="py-10 bg-[rgba(250,250,250,1)]">
            ...
            <div class="flex flex-col lg:flex-row gap-4">
                ...
                <main class="w-full bg-white p-6 sm:p-8 sm:pr-11 rounded-xl shadow-sm relative">
                    ...
                    <form method="post" action="{{ route('agent.profile.update') }}" enctype="multipart/form-data">
                        ...
                        {{-- This x-data block initializes Alpine.js for the live preview --}}
                        <div x-data="{ photoName: null, photoPreview: null }">
                                ...
                                <div class="relative flex items-center gap-x-4 sm:gap-x-[45px]">
                                    ...
                                    <div class="w-24 h-24 sm:w-28 sm:h-28">
                                        <img x-show="!photoPreview"
                                            src="{{ $user->profile_photo_path ? Storage::url($user->profile_photo_path) : asset('images/profile.png') }}"
                                            alt="{{ __('common.profile_image_alt') }}"
                                            class="w-full h-full rounded-full object-cover border-4 border-black shadow-md">
                                        <span x-show="photoPreview"
                                            class="block w-full h-full rounded-full bg-cover bg-no-repeat bg-center border-4 border-black shadow-md"
                                    ...
                                    <div class="absolute top-[70px] sm:top-[80px]">
                                        ...
                                        <label for="profile_photo"
                                            class="bg-[rgba(48,62,124,1)] text-white w-[42px] h-[30px] flex items-center justify-center rounded-full hover:bg-opacity-90 transition-colors cursor-pointer"
                                            aria-label="{{ __('common.change_image_aria_label') }}">
                                    ...
                                    <div class="flex flex-col gap-[15px]">
                                        <p
                                            class="bg-[rgba(27,177,105,0.09)] text-[rgba(27,177,105,1)] text-[14px] font-medium inline-block px-4 py-1.5 rounded-full mb-2 self-start">
                                            {{ __('common.general_account') }}</p>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 px-2 sm:px-9 gap-x-6 gap-y-6">
                                ...
                                <div>
                                    <label for="name"
                                        class="block text-[11px] font-medium mb-2">{{ __('common.name') }}</label>
                                ...
                                <div>
                                    <label for="phone"
                                        class="block text-[11px] font-medium mb-2">{{ __('common.enter_phone') }}</label>
                                    <div class="relative">
                                        ...
                                        <div
                                            class="absolute inset-y-0 left-0 flex items-center px-3 pointer-events-none gap-2">
                                ...
                                <div class="md:col-span-2">
                                    <label for="fal_license"
                                        class="block text-[11px] font-medium mb-2">{{ __('common.fal_license') }}</label>
                                    <input type="text" id="fal_license" name="fal_license"
                                        value="{{ old('fal_license', optional($user->agent)->fal_license) }}"
                            ...
                            <div class="mt-10 text-center">
                                <button type="submit"
                                    class="bg-[rgba(48,62,124,1)] text-[19px] text-white font-medium py-3 px-16 rounded-lg hover:bg-opacity-90 transition-colors shadow-sm">
        ...
        <!-- CTA Section -->
        <section class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-4 py-4">
            <div class="">
                <div
                    ...
                    <div class="relative z-10 flex flex-col items-center text-center">
                        ...
                        <h2 class="text-[15px] font-bold text-[rgba(26,26,26,1)] mb-2">{{ __('common.are_you_an_agent') }}
                        </h2>
                        <p
                            class="max-w-3xl text-[15px] mx-auto text-[rgba(102,102,102,1)] font-medium leading-relaxed mb-4">
                            {{ __('common.agent_upgrade_cta_paragraph') }}
                        </p>
                        <a href="#"
                            class="bg-[#303F7C] text-white font-bold py-3 px-12 rounded-lg hover:bg-opacity-90 transition-colors shadow-md">
                            {{ __('common.convert_account') }}
                        </a>
                    </div>
                </div>
            </div>
