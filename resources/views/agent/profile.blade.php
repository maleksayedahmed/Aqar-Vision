        ...
        <aside class="w-full lg:w-[250px] lg:flex-shrink-0">
            <div class="bg-white p-4 rounded-xl shadow-sm h-full">
                <nav>
                    <ul class="space-y-1">
                        <li>
                            <a href="{{ route('agent.profile.edit') }}" class="flex items-center gap-[10px] p-3 px-4 sm:px-10 rounded-lg text-[rgba(48,62,124,1)] bg-[rgba(48,62,124,0.09)]  hover:bg-gray-100 font-normal text-[16px] transition-colors">
                                <img src="{{ asset('images/account.svg') }}">
                                <span>حسابي</span>
                            </a>
                        </li>
                        <li>
                            <a href="{{ route('agent.my-ads') }}" class="flex items-center gap-[10px] p-3 px-4 sm:px-10 rounded-lg text-[rgba(48,62,124,1)] hover:bg-gray-100 text-[16px] transition-colors">
                ...
                <div x-data="{photoName: null, photoPreview: null}">
                    ...
                    <div class="mb-10 flex flex-col gap-y-6 sm:flex-row sm:justify-between items-start">
                        <div class="relative flex items-center gap-x-4 sm:gap-x-[45px]">
                            ...
                            <div class="absolute top-[70px] sm:top-[80px]">
                                ...
                                <label for="profile_photo" class="bg-[rgba(48,62,124,1)] text-white w-[42px] h-[30px] flex items-center justify-center rounded-full hover:bg-opacity-90 transition-colors cursor-pointer" aria-label="تغيير الصورة">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 px-2 sm:px-9 gap-x-6 gap-y-6">
                        ...
                        <div class="md:col-span-2">
                            ...
                            <input type="text" id="fal_license" name="fal_license" value="{{ old('fal_license', optional($user->agent)->fal_license) }}"
                    ...
                    <div class="mt-10 text-center">
                        <button type="submit" class="bg-[rgba(48,62,124,1)] text-[19px] text-white font-medium py-3 px-16 rounded-lg hover:bg-opacity-90 transition-colors shadow-sm">
                            حفظ التغييرات
                        </button>
                    </div>
                </div>
