        ...
        <div class="flex flex-col w-full lg:flex-row gap-4">
                ...
                <div class="bg-white p-4 rounded-xl shadow-sm h-full">
                    <nav>
                        <ul class="space-y-1">
                            ...
                            <li>
                                <a href="{{ route('agent.complaints.create') }}" class="bg-[rgba(48,62,124,0.09)] flex items-center gap-[10px] p-3 px-4 sm:px-10 rounded-lg text-[rgba(48,62,124,1)] hover:bg-gray-100 text-[16px] transition-colors">
            ...
            <section class="w-full py-16 rounded-xl bg-white">
                <div class="w-full px-4 sm:px-6 lg:px-8">
                    ...
                    <!-- Form -->
                    <form method="POST" action="{{ route('agent.complaints.store') }}" class="space-y-8 max-w-2xl mx-auto">
                        @csrf
                        <!-- Full Name Field -->
                        <div>
