                    ...
                    <nav>
                        <ul class="space-y-1">
                            ...
                            <li>
                                ...
                                <a href="{{ route('agent.complaints.create') }}" class="flex items-center gap-[10px] p-3 px-4 sm:px-10 rounded-lg bg-[rgba(48,62,124,0.09)] text-[rgba(48,62,124,1)] font-normal text-[16px] transition-colors">
