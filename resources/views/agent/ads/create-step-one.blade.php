            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-x-4 md:gap-x-16 gap-y-6">
                ...
                <div class="flex gap-3 items-center h-[52px]">
                    ...
                    <div class="relative w-full h-full">
                        <input type="number" step="any" name="total_price" id="total_price" value="{{ old('total_price') }}" required placeholder="اضف سعر عقارك" class="w-full h-full text-[11px] rounded-lg border border-gray-200 bg-white px-3 pl-12 focus:outline-none focus:ring-1 focus:ring-blue-500">
