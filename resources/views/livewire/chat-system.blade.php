    ...
    <div class="bg-white rounded-2xl shadow-lg p-6 flex flex-col w-full max-w-[844px]" dir="rtl">
        ...
        @if ($selectedConversation)
            ...
            <div class="mt-6 pt-4 border-t">
                ...
                <div wire:loading wire:target="photo" class="text-sm text-gray-500 mb-2">جاري رفع الصورة...</div>
                ...
                <form wire:submit="sendMessage" class="bg-[rgba(249,250,252,1)] rounded-xl p-2 flex flex-row-reverse items-center gap-3">
                     ...
                     <input type="text" wire:model="newMessage" wire:keydown.enter.prevent="sendMessage" placeholder="اكتب رسالتك هنا" class="w-full bg-transparent focus:outline-none text-right placeholder-gray-400">
                </form>
                        ...
                        <div>
                            ...
                            <p class="text-xs {{ $conversation->unread_count > 0 ? 'text-black font-bold' : 'text-gray-400' }}">
                                @if(data_get($conversation, 'lastMessage.image_path') && !data_get($conversation, 'lastMessage.body'))
                                    <span class="text-gray-500">[صورة]</span>
                                @else
