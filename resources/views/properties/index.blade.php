        ...
        <form action="{{ route('properties.search') }}" method="GET" id="filter-form">
            ...
            <div class="flex flex-col-reverse items-center justify-between gap-4">
                ...
                <div id="view-toggle" class="inline-flex p-1 bg-gray-200 rounded-full self-end">
                    <button type="button" class="view-toggle-btn flex items-center gap-2 p-3 text-sm font-semibold rounded-full bg-[rgba(48,63,125,1)] text-white"><img src="{{ asset('images/list.svg') }}"><span>قائمة</span></button>
                    <button type="button" class="view-toggle-btn flex items-center gap-2 p-3 text-sm font-semibold rounded-full text-gray-600"><img src="{{ asset('images/map.svg') }}"><span>خريطة</span></button>
                </div>
            </div>
