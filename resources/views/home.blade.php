...
@section('content')
    ...
    <main class="flex flex-col items-center justify-center min-h-screen pt-[35px]">
        <section class="w-[98%] h-[369px] rounded-[20px] shadow-[0_100px_100px_-60px_rgba(0,0,0,0.2)]">
            ...
            <div class="flex text-center w-[100%] h-[369px] rounded-[20px] items-center flex-col mb-8 bg-[linear-gradient(35.73deg,rgba(44,63,128,0)_-35.73%,#4461A6_118.85%,#2C3F80_152.9%)] bg-cover bg-center pt-[40px] pb-[150px]"
                style="background-image: linear-gradient(114.73deg, rgba(44,63,128,0) -94.73%, #4461A6 118.85%, #2C3F80 152.9%), url('{{ asset('images/hero_banner.jpg') }}');">
                <img src="{{ asset('images/logo-trans.svg') }}" width="120px" alt="logo" style="margin-bottom: 12px;">
        ...
        <!-- Main Form Container -->
        <section
            class="bg-white flex flex-col items-center p-6 rounded-[20px] shadow-sm md:shadow-none mt-[-140px] md:mt-[-100px] w-[80%] lg:w-[878px] h-auto lg:h-auto gap-6 lg:gap-[40px]">
            ...
            <form action="{{ route('properties.search') }}" method="GET" class="w-full">
                ...
                <div class="flex flex-col-reverse items-center gap-4 w-full ltr:flex-row-reverse rtl:flex-row">

                    <button type="submit"
                        class="flex items-center justify-center w-full lg:w-auto h-12 bg-[rgba(48,62,124,1)] text-white font-semibold rounded-lg px-10 hover:bg-indigo-800 focus:outline-none flex-shrink-0">
                    ...
                    <!-- City Dropdown -->
                    <div class="w-full h-12 relative">
                        <div class="absolute inset-y-0 right-0 flex items-center px-3 pointer-events-none"><img
        ...
        <section class="max-w-7xl w-[100%] mx-auto py-12 px-4">
            ...
            <div class="relative">
                <button id="nextBtn"
                    class="absolute cursor-pointer top-1/2 left-0 lg:left-[-50px] z-10 transform -translate-y-1/2 bg-[rgba(236,238,249,1)] border border-gray-200 rounded-full p-2 hover:bg-gray-100"><svg
                        xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 rotate-180 text-[#303E7C]" fill="none"
                        viewBox="0 0 24 24" stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7" />
                    </svg></button>
                <button id="prevBtn"
                    class="absolute cursor-pointer top-1/2 right-0 lg:right-[-35px] z-10 transform -translate-y-1/2 bg-[rgba(236,238,249,1)] border border-gray-200 rounded-full p-2 hover:bg-gray-100"><svg
                        xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 text-[#303E7C]" fill="none" viewBox="0 0 24 24"
                        stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7" />
                    </svg></button>
                <div class="slider-container px-4">
                    <div class="slider-track" id="sliderTrack">
                        @forelse ($latestAds as $ad)
                            <div
                                class="slider-card bg-white border border-gray-100 rounded-xl w-[320px] flex-shrink-0 snap-start shadow-sm hover:shadow-lg transition-shadow duration-300">
                                <div>
                                    <div class="relative">
                                    ...
                                    <div class="p-3 space-y-[23px]">
                                        <div class="flex justify-between items-center text-xs text-[rgba(204,204,204,1)]">
                                            <span class="flex items-center gap-0.5 font-semibold text-black"><svg
            ...
            <section class="max-w-7xl w-[100%] mx-auto py-12 px-4">
                ...
                <div class="relative">
                    <button id="featuredNextBtn"
                        class="absolute cursor-pointer top-1/2 left-0 lg:left-[-50px] z-10 transform -translate-y-1/2 bg-[rgba(236,238,249,1)] border border-gray-200 rounded-full p-2 hover:bg-gray-100">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 rotate-180 text-white" fill="none"
                            viewBox="0 0 24 24" stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7" />
                        </svg>
                    </button>
                    <button id="featuredPrevBtn"
                        class="absolute cursor-pointer top-1/2 right-0 lg:right-[-35px] z-10 transform -translate-y-1/2 bg-[rgba(236,238,249,1)] border border-gray-200 rounded-full p-2 hover:bg-gray-100">
                                ...
                                <div class="flex gap-2 text-sm flex-wrap">
                                    ...
                                    @if (is_array($ad->features))
                                        @foreach (array_slice($ad->features, 0, 3) as $feature)
                                            <span
                                                class="flex items-center gap-1 bg-indigo-50 text-indigo-700 px-2 py-1 rounded-md">
            ...
            <div class="max-w-7xl mx-auto">
                ...
                <div class="relative">
                    <div id="gradient-left"
                        class="absolute top-0 right-0 h-full w-24 bg-gradient-to-l from-white to-transparent z-10 pointer-events-none transition-opacity duration-300 opacity-0">
                    </div>
                    <div id="gradient-right"
                        class="absolute top-0 left-0 h-full w-24 bg-gradient-to-r from-white to-transparent z-10 pointer-events-none transition-opacity duration-300">
                    </div>
                    <div id="agents-slider"
                        class="flex overflow-x-auto gap-5 cursor-grab active:cursor-grabbing select-none px-4 sm:pl-6 lg:pl-8"
                            ...
                            <div class="bg-[rgba(247,249,250,1)] p-5 rounded-2xl flex flex-col gap-2 min-w-[380px]">
                                ...
                                <div class="flex items-center gap-1 text-[rgba(48,62,124,1)]">
                                    ...
                                    <div class="space-y-1">
                                        ...
                                        <div class="flex items-center gap-0.5 text-slate-500 text-[14px]">
                                            <svg xmlns="http://www.w3.org/2000/svg"
                                                class="h-4 w-4 text-[rgba(217,222,242,1)]" viewBox="0 0 20 20"
                                                fill="currentColor">
                                                <path fill-rule="evenodd"
                                                    d="M5.05 4.05a7 7 0 119.9 9.9L10 20l-4.95-6.05a7 7 0 010-9.9zM10 11a2 2 0 100-4 2 2 0 000 4z"
                                                    clip-rule="evenodd" />
        ...
        <section class="my-16 flex justify-center px-4">
            <div class="w-full lg:w-[1120px] text-center p-6 md:p-8 lg:p-12 rounded-2xl bg-cover bg-center"
                ...
                <a href="{{ route('user.ads.create') }}"
                    class="inline-block bg-[#2C3F80] text-white font-semibold py-3 px-10 rounded-full 
         hover:bg-white hover:text-[#1A244C] 
         transition-colors 
...
if (sliderTrack && nextBtn && prevBtn) {
    ...
    <?php endif; ?>
            ...
            if (agentsSlider) {
                ...
                agentsSlider.addEventListener('mouseleave', () => {
                    isDown = false;
                    agentsSlider.classList.remove('active');
                });
                agentsSlider.addEventListener('mouseup', () => {
                    isDown = false;
                    agentsSlider.classList.remove('active');
                });
