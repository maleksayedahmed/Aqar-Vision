        ...
        <form action="#" method="GET" class="w-full">
            <div class="flex flex-col-reverse lg:flex-row-reverse items-center gap-4 w-full">
                ...
                <div class="w-full h-12">
                    <select name="country_id" id="country-select" class="w-full h-full bg-white border border-gray-200 rounded-lg px-4 cursor-pointer hover:border-indigo-400 transition-colors text-sm font-medium text-gray-700">
                ...
                <!-- City Dropdown -->
                <div class="w-full h-12">
                    <select name="city_id" id="city-select" class="w-full h-full bg-white border border-gray-200 rounded-lg px-4 cursor-pointer hover:border-indigo-400 transition-colors text-sm font-medium text-gray-700" disabled>
        ...
        <div class="relative">
            ...
            <div class="slider-container px-4">
                <div class="slider-track" id="sliderTrack">
                    <!-- Property Cards will be dynamically inserted here or statically placed -->
                    @for ($i = 0; $i < 4; $i++)
                    <div class="slider-card bg-white border border-gray-100 rounded-xl w-[320px] flex-shrink-0 snap-start shadow-sm hover:shadow-lg transition-shadow duration-300">
                        <div>
                            <div class="relative">
                                <img src="https://images.pexels.com/photos/1396122/pexels-photo-1396122.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1" class="w-full h-48 object-cover rounded-lg" alt="شقة مميزة للإيجار">
                ...
                <div id="agents-slider" class="flex overflow-x-auto gap-5 no-scrollbar px-4 sm:pl-6 lg:pl-8">
                    ...
                    <div class="bg-[rgba(247,249,250,1)] p-5 rounded-2xl flex flex-col gap-2 min-w-[380px]">
                        ...
                        <div class="flex items-center gap-1 text-[rgba(48,62,124,1)]">
                            <img src="{{ asset('images/agent.png') }}" alt="Agent" class="w-16 h-16 rounded-full object-cover border-2 border-white">
                            <div class="space-y-1">
                                <div class="flex items-center gap-0.5 text-slate-500 text-[9px]"><svg xmlns="http://www.w3.org/2000/svg" class="h-3 w-3 text-[rgba(217,222,242,1)]" viewBox="0 0 20 20" fill="currentColor"><path fill-rule="evenodd" d="M5.05 4.05a7 7 0 119.9 9.9L10 20l-4.95-6.05a7 7 0 010-9.9zM10 11a2 2 0 100-4 2 2 0 000 4z" clip-rule="evenodd" /></svg><span>الرياض</span></div>
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        // Dynamic Country/City Dropdown Logic
        ...
        if (countrySelect && citySelect) {
            countrySelect.addEventListener('change', function() {
                ...
                fetch(`/api/locations/countries/${countryId}/cities`)
                    .then(response => {
