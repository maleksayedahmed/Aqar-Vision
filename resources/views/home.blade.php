                        ...
                        <div class="bg-[rgba(247,249,250,1)] p-5 rounded-2xl flex flex-col gap-2 min-w-[380px]">
                            ...
                            <div class="flex justify-between items-center gap-[60px] pt-2">
                                ...
                                <div class="flex items-center gap-1">
                                    <a href="#" class="h-[27px] px-3 flex items-center gap-2 rounded-lg bg-[rgba(48,63,125,1)] text-white hover:bg-indigo-800 transition-colors text-xs font-normal"><span>اتصل بنا</span></a>
                                    <a href="#" class="h-[27px] px-3 flex items-center gap-2 rounded-lg border border-slate-300 text-slate-700 hover:bg-slate-200/50 transition-colors text-xs font-normal"><span>تواصل معنا</span></a>
