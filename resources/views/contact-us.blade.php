                    ...
                    <!-- Inputs... (make sure they have `name` attributes) -->
                     <!-- Name -->
                        ...
                        <div>
                            ...
                            <input type="email" id="email" name="email" placeholder="ادخل البريد الالكتروني" class="text-[14.2px] w-full bg-[#F9F9F9] text-gray-500 rounded-[12px] py-3 px-5 focus:outline-none focus:ring-2 focus:ring-[#303F7C]">
                        </div>
                         <!-- Service Type -->
                        <div>
