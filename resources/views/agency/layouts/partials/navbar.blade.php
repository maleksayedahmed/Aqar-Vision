...
<header class="header header-sticky p-0 mb-4">
    <div class="container-fluid border-bottom px-4">
        ...
        <ul class="header-nav d-none d-lg-flex">
            <li class="nav-item"><a class="nav-link" href="{{ route('agency.dashboard') }}">Dashboard</a></li>
        </ul>
    ...
    <div class="container-fluid px-4">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb my-0">
                <li class="breadcrumb-item"><a href="{{ route('agency.dashboard') }}">Home</a></li>
                <li class="breadcrumb-item active"><span>@yield('breadcrumb', 'Dashboard')</span></li>
            </ol>
        </nav>
    </div>
</header>
