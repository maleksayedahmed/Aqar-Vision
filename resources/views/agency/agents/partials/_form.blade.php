...
<h5 class="mb-3">@lang('agency.agents.user_account_details')</h5>
<div class="row">
    ...
    <div class="col-md-6 mb-3">
        <label for="phone">@lang('agency.agents.phone_number')</label>
        <input type="text" name="phone" class="form-control" value="{{ old('phone', $agent->user->phone ?? '') }}" required>
    </div>
</div>
<div class="row">
    <div class="col-md-6 mb-3">
        <label for="password">@lang('agency.agents.password')</label>
        <input type="password" name="password" class="form-control" {{ $agent->exists ? '' : 'required' }}>
        @if($agent->exists)<small class="form-text text-muted">@lang('agency.agents.leave_blank_password')</small>@endif
    </div>
    <div class="col-md-6 mb-3">
        <label for="password_confirmation">@lang('agency.agents.confirm_password')</label>
        <input type="password" name="password_confirmation" class="form-control">
    </div>
</div>
<hr>
<h5 class="my-3">@lang('agency.agents.agent_profile_details')</h5>
<div class="row">
    <div class="col-md-4 mb-3">
        <label for="agent_type_id">@lang('agency.agents.agent_type')</label>
    ...
    <div class="col-md-4 mb-3">
        <label for="city_id">@lang('agency.agents.city')</label>
    ...
    <div class="col-md-4 mb-3">
        <label for="license_number">@lang('agency.agents.license_number_fal')</label>
