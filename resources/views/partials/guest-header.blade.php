...
<div class="flex items-center gap-[50px]">
    ...
    <div class="hidden lg:flex gap-[26px]">
        ...
        <div class="hidden md:flex relative">
            <button id="language-menu-button-guest" type="button" class="flex items-center gap-x-2 text-sm bg-gray-200 hover:bg-gray-300 px-3 py-2 rounded-lg transition-colors" aria-expanded="false" aria-haspopup="true">
                ...
                <svg class="w-4 h-4 text-gray-600 transition-transform" id="language-dropdown-arrow-guest" fill="currentColor" viewBox="0 0 20 20"><path fill-rule="evenodd" d="M5.293 7.293a1 1 0 011.414 0L10 10.586l3.293-3.293a1 1 0 111.414 1.414l-4 4a1 1 0 01-1.414 0l-4-4a1 1 0 010-1.414z" clip-rule="evenodd"></path></svg>
            </button>

            <!-- Dropdown Menu -->
            <div id="language-menu-guest" class="hidden absolute left-0 mt-12 w-40 origin-top-left rounded-lg bg-white shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none z-50" role="menu" aria-orientation="vertical" aria-labelledby="language-menu-button-guest">
                <div class="py-1">
