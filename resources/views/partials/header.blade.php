    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-4">
        <div class="flex items-center justify-between h-16">
            ...
            <div class="flex items-center gap-x-4 lg:gap-x-[45px]">
                <a href="{{ route('properties.map') }}" class="hidden lg:flex bg-[rgba(48,63,125,1)] hover:bg-blue-700 text-white px-4 py-2 rounded-lg items-center gap-2 transition-colors duration-200 text-sm font-medium shadow-sm">
                    ...
                    <div class="relative">
                        ...
                        <div id="user-menu" class="hidden absolute left-[-10px] mt-4 w-[200px] origin-top-left rounded-lg bg-white p-5 shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none" role="menu" aria-orientation="vertical" aria-labelledby="user-menu-button" tabindex="-1">
                            ...
                            <div class="space-y-[10px]">
                                ...
                                <a href="#" class="p-1 rounded flex items-center gap-[10px] text-[13px] font-light text-[#303f7d] transition-opacity hover:opacity-75" role="menuitem">
