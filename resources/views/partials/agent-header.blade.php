            ...
            <div class="flex items-center gap-[50px]">
                ...
                <div class="hidden lg:flex gap-[33px]">
                    <nav class="hidden lg:flex items-center gap-x-6">
                        ...
                        <a href="{{ route('agent.my-ads') }}" class="{{ request()->routeIs('agent.my-ads') ? 'text-[rgba(79,171,232,1)]' : 'text-[rgba(48,62,124,1)]' }} text-sm font-medium text-[rgba(48,62,124,1)] hover:text-[rgba(48,62,124,1)]">إعلاناتي</a>
                        ...
                        <a href="{{ route('agent.contact') }}" class="text-sm font-medium {{ request()->routeIs('agent.contact') ? 'text-[rgba(79,171,232,1)]' : 'text-[rgba(48,62,124,1)]' }} hover:text-[rgba(48,62,124,1)]">تواصل معنا</a>
                    </nav>
                </div>
            </div>
            ...
            <div class="flex items-center gap-x-4 lg:gap-x-[45px]">
                ...
                <div class="flex items-center gap-[12.5px]">
                    ...
                    <div class="hidden md:flex relative">
                        <button id="language-menu-button-agent" type="button" class="flex items-center gap-x-2 text-sm bg-gray-200 hover:bg-gray-300 px-3 py-2 rounded-lg transition-colors" aria-expanded="false" aria-haspopup="true">
                            ...
                            <svg class="w-4 h-4 text-gray-600 transition-transform" id="language-dropdown-arrow-agent" fill="currentColor" viewBox="0 0 20 20"><path fill-rule="evenodd" d="M5.293 7.293a1 1 0 011.414 0L10 10.586l3.293-3.293a1 1 0 111.414 1.414l-4 4a1 1 0 01-1.414 0l-4-4a1 1 0 010-1.414z" clip-rule="evenodd"></path></svg>
                        </button>

                        <!-- Dropdown Menu -->
                        <div id="language-menu-agent" class="hidden absolute left-0 mt-12 w-40 origin-top-left rounded-lg bg-white shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none z-50" role="menu" aria-orientation="vertical" aria-labelledby="language-menu-button-agent">
                            <div class="py-1">
                    ...
                    <div class="relative">
                        ...
                        <div id="user-menu" class="hidden absolute left-[-10px] mt-4 w-[200px] origin-top-left rounded-lg bg-white p-5 shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none" role="menu" aria-orientation="vertical" aria-labelledby="user-menu-button" tabindex="-1">
                            ...
                            <div class="space-y-[10px]">
                                <a href="{{ route('agent.profile.edit') }}" class="flex items-center gap-[10px] text-[13px] font-light text-[#303f7d] transition-opacity hover:opacity-75" role="menuitem">
                                ...
                                <a href="{{ route('agent.notifications') }}" class="flex items-center gap-[10px] text-[13px] font-light text-[#303f7d] transition-opacity hover:opacity-75" role="menuitem">
                                ...
                                <a href="{{ route('agent.my-ads') }}" class="flex items-center gap-[10px] text-[13px] font-light text-[#303f7d] transition-opacity hover:opacity-75" role="menuitem">
                                ...
                                <a href="{{ route('agent.about-us') }}" class="flex items-center gap-[10px] text-[13px] font-light text-[#303f7d] transition-opacity hover:opacity-75" role="menuitem">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="15" height="14" viewBox="0 0 15 14" fill="none">
                                ...
                                <a href="{{ route('agent.terms-of-use') }}" class="flex items-center gap-[10px] text-[13px] font-light text-[#303f7d] transition-opacity hover:opacity-75" role="menuitem">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 14 14" fill="none">
                                ...
                                <a href="{{ route('agent.complaints.create') }}" class="flex items-center gap-[10px] text-[13px] font-light text-[#303f7d] transition-opacity hover:opacity-75" role="menuitem">
                                     <svg xmlns="http://www.w3.org/2000/svg" width="15" height="14" viewBox="0 0 15 14" fill="none">
