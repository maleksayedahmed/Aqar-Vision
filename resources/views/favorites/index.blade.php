            ...
            <div class="flex-1">
                <div class="bg-white rounded-xl shadow-sm p-6">
                    <div class="flex items-center justify-between mb-6">
                        <h1 class="text-2xl font-bold text-slate-800">المفضلة</h1>
                        <div class="text-sm text-gray-500">
                            {{ $favorites->total() }} عقار
                        </div>
                    </div>
                            ...
                            @foreach ($favorites as $ad)
                                <div class="bg-white border border-gray-100 rounded-xl shadow-sm hover:shadow-lg transition-shadow duration-300">
                                    <div class="relative">
                                        ...
                                        <div class="absolute top-2 left-2 bg-white text-[rgba(48,62,124,1)] text-xs font-medium px-2 py-1 rounded">
                                            {{ $ad->listing_purpose == 'rent' ? 'إيجار' : 'بيع' }}
                                        </div>
                                        <button class="favorite-btn absolute top-2 right-2 bg-[rgba(255,255,255,0.27)] p-1.5 rounded-lg hover:shadow"
                                                data-ad-id="{{ $ad->id }}" data-favorited="true">
                                            <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 text-red-500" fill="currentColor" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                    ...
                    @else
                        <div class="text-center py-12">
                            ...
                            <h3 class="mt-4 text-lg font-medium text-gray-900">لا توجد عقارات مفضلة</h3>
                            <p class="mt-2 text-sm text-gray-500">ابدأ بإضافة عقارات إلى قائمة المفضلة لديك</p>
                            <div class="mt-6">
                                <a href="{{ route('properties.search') }}" class="inline-flex items-center px-4 py-2 border border-transparent shadow-sm text-sm font-medium rounded-md text-white bg-[rgba(48,62,124,1)] hover:bg-indigo-800 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">
                                    تصفح العقارات
                                </a>
                            </div>
                        </div>
